    ...
    <form onSubmit={handleSubmit(submitContactForm)} className='flex flex-col gap-7'>
        ...
        <div className='flex flex-col gap-5 lg:flex-row'>
            ...
            <div className='flex flex-col gap-2 lg:w-[48%]'>
                ...
                id='firstname'
                placeholder='Enter first name' style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)",}} className='w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5'
            ...
            <div className='flex flex-col gap-2 lg:w-[48%]'>
                ...
                id='lastname'
                placeholder='Enter last name' style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)",}} className='w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5'
                //is state ko register kar diya.StateName = firstname, validation = true
                {...register('lastname')}
                />
        ...
        <div className='flex flex-col gap-2'>
                ...
                <input
                    ...
                    style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)",}} className='w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5'
                ...
                <div className='w-[calc(100%-110px)]'>
                    <input
                        ...
                        {...register('phoneNo', {
                            ...
                            minLength:{
                                value:8, message:'Invalid phone number'
                            }
                        })}
                        style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)",}} className='w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5'
                    />
        ...
        {/* submit button */}
        <button type='submit' className={`rounded-md bg-yellow-50 px-6 py-3 text-center text-[16px] font-bold text-black shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)]`}>
            Send Message
        </button>
    </form>
  )
