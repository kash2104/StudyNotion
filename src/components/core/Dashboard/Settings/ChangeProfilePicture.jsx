...
const ChangeProfilePicture = () => {
    ...
    //if I want the value of the html elements, I need the useRef hook to access those elements.
    ...
    const handleFileUpload = () => {
        try {
            ...
            console.log('Error while selecting file on frontend', error.message);
        }
    }
