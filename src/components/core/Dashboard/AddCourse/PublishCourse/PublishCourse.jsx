...
const PublishCourse = () => {
  ...
  const handleCoursePublish = async () => {
    if (
      ...
      //the form has not been updated so no need for api call
      goToCourses();
      return;
    }
    ...
    //updating the course details -> draft ko published kar denge
    setLoading(true);
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="ml-auto flex max-w-max items-center gap-x-4">
          <button
            ...
            type="button"
            onClick={goBack}
            className="flex items-center rounded-md cursor-pointer gap-x-2 bg-richblack-300 py-[8px] px-[20px] font-semibold text-richblack-900"
          >
            Back
          </button>
