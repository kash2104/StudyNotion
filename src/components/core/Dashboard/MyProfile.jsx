  ...
  return (
    <div>
        ...
        <div className='my-10 flex flex-col gap-y-10 rounded-md border-[1px] border-richblack-700 bg-richblue-800 p-8 px-12'>
            ...
            {/* if additional details has about info then show that info. */}
            ...
            <div className='flex max-w-[500px] justify-between'>
                ...
                <div className='flex flex-col gap-y-5'>
                    ...
                    <div>
                        ...
                        <p className='text-sm font-medium text-richblack-5'>{user?.additionalDetails?.contactNumbers ?? 'Add Contact Number'}</p>
                    </div>
