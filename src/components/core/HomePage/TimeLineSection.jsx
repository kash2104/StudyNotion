  ...
  return (
    <div>
        <div className='flex flex-col lg:flex-row gap-20 mb-20 items-center'>
            ...
            <div className='w-[45%] flex flex-col lg:gap-5 gap-14'>
                {
                    timeline.map((element, index) => {
                        return (
                            <div className='flex flex-row gap-6' key={index}>
                                ...
                                <div className={`hidden ${timeline.length -1 === index ? 'hidden' : 'lg:block'} h-14 border-dotted border-r border-richblack-100 bg-richblack-400 w-[1px]`}>
