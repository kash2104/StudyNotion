...
export const Codeblocks = ({position,heading,subheading,ctabtn1, ctabtn2, codeblock, backgroundGradient, codeColor}) => {
  return (
    <div className={`flex ${position} my-20 justify-between gap-10`}>
        ...
        {/* section 2 - animated coding block */}
        {/* bigger wrap, indexing, running code animation */}
        <div className='h-fit flex flex-row text-[15px] w-[100%] py-4 lg:w-[500px]'>
            ...
            {/* contains code animation */}
            <div className={`w-[90%] flex flex-col gap-2 font-bold font-mono ${codeColor} ${backgroundGradient} pr-2`}>
                <TypeAnimation
