  ...
  return (
    <div>
        ...
        <p className='text-center text-richblack-300 text-sm text-[16px] mt-3'>
            Learn to build anythig you can imagine
        </p>
        ...
        <div className='lg:absolute gap-10 flex flex-row flex-wrap justify-center lg:gap-0 lg:justify-between w-full lg:bottom-[0] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[50%] text-black lg:mb-4 mb-7 lg:px-0 px-3'>
            {
