    ...
    <div>
        ...
        <section className='bg-richblack-700'>
            <div className='relative mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-center text-white'>
                ...
                <div className='w-[100%] lg:gap-5 grid grid-cols-3 bottom-0 absolute left-[50%] translate-x-[-50%] translate-y-[30%] gap-3'>
            ...
            <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>
                ...
                <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                    ...
                    <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                        <h1 className='bg-gradient-to-br from-[#833AB4] via-[#FD1D1D] to-[#FCB045] bg-clip-text text-4xl font-semibold text-transparent lg:w-[70%]'>Our Foundating Story</h1>
                    ...
                    {/* right box */}
                    <div>
                        <img src={FoundingStory} alt='Founding Story' className='shadow-[0_0_20px_0] shadow-[#FC6767]'/>
                    </div>
                </div>
